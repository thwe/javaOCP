 ...
 * so kann jede beliebige Referenz an diese Methode �bergeben. Grund: Jede
...
public class ApplikationCast {
	...
	private static void validCastOperations(){
		...
		b.test();
		//Die linke Seite entscheidet dar�ber welche Methoden zur Verf�gung stehen 
	    // auch statische Polymorphie genannt
		
		//Die rechte Seite entscheidet dar�ber aus welcher Klasse 
		...
		//zwei v�llig unterschiedliche Klassen 
