...
public class TestTanken {
	...
	public static void main(String[] args) {
		...
		System.out.println("Füllstand (vorher): " + tank.getTankinhalt() + "  /  Tanklimit: " + tank.getMaxVolumen());
		tanksaeule.tankstutzenEntnehmen(tank);
		tanksaeule.startTanken();
		System.out.println("Füllstand (nachher): " + tank.getTankinhalt() + "  /  Tanklimit: " + tank.getMaxVolumen());
