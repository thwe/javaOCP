...
class Consumer extends Thread {
	...
	public void run() {
		while(true) {
			...
			//Achtung! Zugriffe auf habeDaten m�ssen noch synchronisiert werden
...
/*
 * - Die Kommunikation zw. dem Producer und Consumer l�uft �ber den GEMEINSAMEN Monitor!
 * - wait/notify/notifyAll m�ssen aus einem synchronized-Block aufgerufen werden
